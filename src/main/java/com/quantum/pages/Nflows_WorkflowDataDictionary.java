...
public class Nflows_WorkflowDataDictionary extends WebDriverBaseTestPage<WebDriverTestPage> 
{
	@FindBy(locator = "nflows.wfDataDict.newField.button")
	private QAFExtendedWebElement newField;
		
	@FindBy(locator = "nflows.wfDataDict.Search.button")
	private QAFExtendedWebElement wfDDSearch;
	...
	public QAFExtendedWebElement getwfDDSearch() {
		return wfDDSearch;
	}
